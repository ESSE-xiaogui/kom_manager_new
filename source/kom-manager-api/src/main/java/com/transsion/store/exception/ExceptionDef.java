...
public enum ExceptionDef {
	...
	ERROR_TASK_NONEXIST(203,"ERROR_TASK_NONEXIST","任务不存在"),
	...
	ERROR_SALE_TOO_MANY_RESULTS(1002,"ERROR_SALE_TOO_MANY_RESULTS","销量查询错误"),
	

	ERROR_STOCK(1100, "ERROR_STOCK","库存管理错误"),
	...
	ERROR_PROTOTYPESETTING_DATE_INVALID(1502,"ERROR_PROTOTYPESETTING_DATE_INVALID","样机盘点日期设置错误"),
	ERROR_PROTOTYPESETTING_TOO_MANY_RESULTS(1503,"ERROR_PROTOTYPESETTING_TOO_MANY_RESULTS","样机盘点已设置"),
	...
	private ExceptionDef(int code, String name, String comment)
	{
		this.code=code;
		this.name=name;
