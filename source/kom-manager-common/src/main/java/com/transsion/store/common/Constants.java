...
public class Constants {
    ...
    public static final String QRCODEAPI = "http://176.34.150.246:8081/api/kom";//正式机
...
//  public static final String IMEIAPI = "http://open.af1225.com/api/komByImei";//正式机
    ...
    public static final String IMEIAPI = "http://176.34.150.246:8081/api/komByImei1";//正式机
    
    //public static final String BATCHIMEIAPI = "http://open.af1225.com/api/checkBatchImei";//正式机
    public static final String BATCHIMEIAPI = "http://176.34.150.246:8081/api/checkBatchImei";//正式机
